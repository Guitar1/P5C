...
public class UsbMassManager {
    ...
    public UsbMassManager(Context context) {
        mStorageManager = context.getSystemService(Context.STORAGE_SERVICE);
    ...
    public void enableUsbMass() {
        ...
        try {
            Method enable = mStorageClass.getMethod(mEnableMethod, (Class[]) null);
            enable.invoke(mStorageManager, (Object [])null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
